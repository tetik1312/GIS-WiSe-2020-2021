namespace Rakete {
    export let spitzenAuswahl: Spitze[] = [
    ...
    let mySpitze: Spitze[] = spitzenAuswahl;
    let myJSON: string = JSON.stringify(mySpitze);
    console.log(myJSON);
    ...
    let myRumpf: Rumpf[] = rumpfAuswahl;
    let myJSON1: string = JSON.stringify(myRumpf);
    console.log(myJSON1);

    export let antriebAuswahl: Antrieb[] = [
    ...
    let myAntrieb: Antrieb[] = antriebAuswahl;
    let myJSON2: string = JSON.stringify(myAntrieb);
    console.log(myJSON2);
}
